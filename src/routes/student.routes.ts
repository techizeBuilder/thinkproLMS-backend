...
router.get("/promotion", getStudentsForPromotion); // Get students for grade promotion
...
router.post("/promote", requirePermission("ADD_STUDENTS"), promoteStudents); // Promote students to next grade
